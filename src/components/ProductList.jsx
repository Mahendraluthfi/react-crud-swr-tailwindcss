...
const ProductList = () => {
  ...
  const {data} = useSWR('products', fetcher,{ refreshInterval: 1000 })
  ...
  return (
    <div className='flex flex-col mt-5'>
      <div className='w-full'>
          <Link to="/add" className='bg-green-500 hover:bg-green-700 border border-slate-100 text-white font-bold py-2 px-4 rounded'>Add New</Link>
